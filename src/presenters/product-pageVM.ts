...
export const toProductPageVM = (productPage: ProductPageVM) => {
  ...
  return {
    ...
    big_screenshot: big_screenshot_field.length > 0 && big_screenshot_field[0].big_screenshot.url
    ...
    screenshot_gallery: screenshot_gallery_field.length > 0 && screenshot_gallery_field[0].screenshot_gallery.url
